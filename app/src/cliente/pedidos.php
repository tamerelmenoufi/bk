...
<div class="col">
    <div class="row">
        <div class="col">
<?php
    $query = "select * from vendas where cliente = '{$_SESSION['AppCliente']}' and deletado != '1' and (operadora_situacao = 'approved' or forma_pagamento = 'pix') /*and data_finalizacao > 0*/ order by data_pedido desc";
