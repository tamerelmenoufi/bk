                    ...
                    <div class="row">
                        <div class="col-12">
                            <h5 class="card-title">
                                ...
                                ?>
                                <div class="alertas animate__animated animate__fadeIn animate__infinite animate__slower animate__delay-5s">Dados Incompletos, atualize para fechar o seu pedido.</div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h5 class="card-title">
                                ...
                                if(!$coordenadas){
                                ?>
                                <div class="alertas animate__animated animate__fadeIn animate__infinite animate__slower animate__delay-5s">Endereço Pendente de validação.</div>
                            ...
                            ?>
                            <div class="alertas animate__animated animate__fadeIn animate__infinite animate__slower animate__delay-5s">
