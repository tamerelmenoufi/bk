...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($codigo) {
        $query = "UPDATE categorias_itens SET {$attr} WHERE codigo = '{$codigo}'";
    } else {
        $query = "INSERT INTO categorias_itens SET {$attr}";
    }
    ...
    if (mysqli_query($con, $query)) {
        ...
        sis_logs('categorias_itens', $codigo, $query);
...
if ($codigo) {
    $query = "SELECT * FROM categorias_itens WHERE codigo = '{$codigo}'";
