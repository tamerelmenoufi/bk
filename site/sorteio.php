...
<center>
    ...
    $query = "select * from clientes where sorteio = '1' and data_promocao like '%2022-12-23%' order by sorteio_data asc";
...
if($_GET['s']){
    ...
    $q = "select * from clientes where data_promocao like '%2022-12-23%' and sorteio != '1' order by rand() limit 1";
